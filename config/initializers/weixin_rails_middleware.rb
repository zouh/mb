...
WeixinRailsMiddleware.configure do |config|
  ...
  config.public_account_class = "Organization"
  ...
  # config.weixin_token_string = 'e6dbe00929e0dce6bb643b34'
  # using to weixin server url to validate the token can be trusted.
  # config.weixin_secret_string = '8DZnnv3k0Hr5D50IoDmx40T0pNXI3OFD'
  # 加密配置，如果需要加密，配置以下参数
  # config.encoding_aes_key = '119800cd2385b4948e45c566fe61aa64295622264d3'
